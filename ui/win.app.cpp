...
void AppWin::initMenu() {
	...
	mTools.setText("Tools");
		mTools_OptMidi.setText("Convert to MIDI Options");
	mHelp.setText("Help");
...
AppWin::AppWin(int argc, char** argv) {
	...
	mTools_OptMidi.onActivate = [&]() { MessageWindow::information(*this, "TODO: open to-midi options window"); };
